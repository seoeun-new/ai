...
export const UploadPhotos = styled.div`
  ...
  .photo-list {flex:1;overflow:hidden;padding:0 1.2rem;
    .swiper-wrapper { display: flex; align-items: center;
      ...
      .swiper-slide { position: relative; width: 8rem; height: 7.2rem; min-width: 7.2rem;
        ...
        .img { width: 100%; height: 100%; position: relative; overflow: hidden; border-radius: 0.6rem; overflow: hidden; border: 1px solid #D9D9D9;
          img { position: absolute; top: 50%; left: 50%; width: 100%; height: 100%; object-fit: contain; margin: auto; transform:translate(-50%, -50%);}
        }
      }
    }
  }
